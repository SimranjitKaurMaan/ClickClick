 ...
 * <p/>
 * ************ IMPORTANT SETUP NOTES: ************ In order for Google+ sign in to work with your app, you must first
 * go to: https://developers.google.com/+/mobile/android/getting-started#step_1_enable_the_google_api and follow the
 * steps in "Step 1" to create an OAuth 2.0 client for your package.
 */
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor>
{
	...
	/**
	 * Check if the device supports Google Play Services. It's best practice to check first rather than handling this as
	 * an error case.
	 * 
	...
	/**
	 * Use an AsyncTask to fetch the user's email addresses on a background thread, and update the email text field with
	 * results on the main UI thread.
	 */
